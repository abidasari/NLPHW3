...
sentence = ["I", "want", "to", "race", "to", "Mars", "you", "fool" ]
...
sentence_p = "I want to race to mars you fool"
sentence_as_list = sentence_p.split(' ')
outstring = ""
for index, value in enumerate(sentence_as_list):
    outstring = outstring + value + "/" + best_tagsequence[index+1] + " "
